     ...
     <header className={`header${showNav ? " body-pd" : ""}`}>
      ...
      <div className={`sidebar${showNav ? " open" : ""}`}> 
        ...
        <div className="home-section">
          ...
          <a href="/user/suratkeluar" target="_blank" rel="noreferrer noopener" style={{backgroundColor: '#F2444F', padding: '5px 10px', borderRadius: '5px'}}>
            <MdEmail /> <span className="links_name"><b> Unduh Surat Selesai Magang </b></span>
        </a>
<br></br>
          <a href="/user/sertifikat" target="_blank" rel="noreferrer noopener" style={{backgroundColor: '#F2444F', padding: '5px 10px', borderRadius: '5px'}}>
            <MdEmail /> <span className="links_name"><b> Unduh Sertifikat Magang </b></span>
          </a>
          <Footer /> 
        </div>
      </div>
